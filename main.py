...
openai.api_key = open('.venv/API_KEY', 'r').read() # text file containing the OpenAI API key is in .venv/API_KEY
...
# Plots the stock price on a graph and saves it in the local directory as stock.png
...
functions = [
    ...
    {
        'name': 'calculate_MACD',
        'description': 'Calculate the MACD for a given stock ticker and a short and a long window.',
        'parameters': {
            'type': 'object',
            'properties': {
                'ticker': {
...
if user_input:
    try:
        ...
        if response_message.get('function_call'):
            ...
            function_response = function_to_call(**args_dictionary)
